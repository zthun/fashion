...
## [15.0.1](https://github.com/zthun/fashion/compare/v15.0.0...v15.0.1) (2026-08-25)
...
## [14.0.1](https://github.com/zthun/fashion/compare/v14.0.0...v14.0.1) (2026-04-26)

**Note:** Version bump only for package @zthun/fashion

# [14.0.0](https://github.com/zthun/fashion/compare/v13.0.5...v14.0.0) (2026-04-05)

### Bug Fixes

- border colors on buttons now respect fashion ([37c544f](https://github.com/zthun/fashion/commit/37c544f8e7dac2af054ad4c7ff4cbcad6fbddb8e))
- box now has active state colors for interactive boxes ([24769cd](https://github.com/zthun/fashion/commit/24769cd9731e69090dda64997c4ab08e879d761d))
- button page now has more padding between the demos ([f03e705](https://github.com/zthun/fashion/commit/f03e7053dbebe235d909d2a178903ac09e526f87))
- component fashions should now properly support gradients ([bfd90e2](https://github.com/zthun/fashion/commit/bfd90e29bb54b46ea6aeebd803e63b08c7985382))
- popup page button is now sized better to its content ([ed7a4cd](https://github.com/zthun/fashion/commit/ed7a4cd1dc5641145e9da68d2e2703da7bfaa61a))

### Code Refactoring

- card no longer supports fashion ([6cde42a](https://github.com/zthun/fashion/commit/6cde42a75609eee493f8434e02e21333da029f1f))
- card page has been removed ([5d2a1b7](https://github.com/zthun/fashion/commit/5d2a1b72770c3595667bbe5d4dc2b3eaad8d74fa))
- fashion state signatures ([5997808](https://github.com/zthun/fashion/commit/59978089d2b0a37f361e265cb2daf09667e7e6be))
- move theme to new package ([62d7489](https://github.com/zthun/fashion/commit/62d7489485ef0bd4cd3d6d264008ba3cb89df963))
- remove spectrum ([9ae3c55](https://github.com/zthun/fashion/commit/9ae3c55b874fbb6ea2e3b88842b05e25659481de))

### Features

- card now has rounded corners ([66f5f30](https://github.com/zthun/fashion/commit/66f5f30502f195b9e877339e2e758945f836e4e1))
- dark theme now uses gradients ([fd99a50](https://github.com/zthun/fashion/commit/fd99a500d957d2c99935899f70619bdfe35521ee))
- default fashion for a chart progress is now secondary ([91c0a47](https://github.com/zthun/fashion/commit/91c0a47dc9a2d0fa653c699618e4c137d7426404))
- default fashion for alert is now error ([9156a9e](https://github.com/zthun/fashion/commit/9156a9ea7f508d5aafc7703df8cf170f9526157f))
- default fashion for choice components is now secondary ([1840648](https://github.com/zthun/fashion/commit/18406482950ae9a8d22f1745961724888041e229))
- default fashion for dialogs is now universally surface ([8d5ecf0](https://github.com/zthun/fashion/commit/8d5ecf03c8e313feedd8294e4bfd063652eafb4e))
- default fashion for suspense progress is now secondary ([3342787](https://github.com/zthun/fashion/commit/3342787153b217f48262bd4af43501c964eb6000))
- fashion no longer supports the visited state ([538f778](https://github.com/zthun/fashion/commit/538f778c396485ceaec796fe9a5fb586fde5006d))
- fashion-theme-dark supplies a dark fashion theme ([661b377](https://github.com/zthun/fashion/commit/661b3771fbf4366367ddf4beec87f57217863ac2))
- links no longer show visited state ([983fc3a](https://github.com/zthun/fashion/commit/983fc3aeb786b61f3aa2cd3a25c27a5953eb8693))
- tertiary is now supported ([f899541](https://github.com/zthun/fashion/commit/f89954128dba1e72031ca20f09f6d79c8bd26eda))
- you can now set the fashion on the drawer page ([c02ee84](https://github.com/zthun/fashion/commit/c02ee84c8c97de130d79adccb9d002b5e3605df2))

### BREAKING CHANGES

- The light theme has been removed
- The dark theme has been extracted to a new package
- Card page has been removed. Every page displays cards so there is
  no point to a demo
- card component no longer supports fashion and will always use
  surface
- Method, spectrum, in ZFashionBuilder is no longer supported
- Fashion state main has been split into foreground and
  background to support text and background gradients and images
- ZLink no longer shows visited states
- The visited state is no longer supported

## [13.0.5](https://github.com/zthun/fashion/compare/v13.0.4...v13.0.5) (2026-02-14)

**Note:** Version bump only for package @zthun/fashion

## <small>13.0.4 (2026-01-31)</small>

- build: update outdated packages ([4c91401](https://github.com/zthun/fashion/commit/4c91401))
- chore: update yarn lockfile [skip ci] ([9812279](https://github.com/zthun/fashion/commit/9812279))

## [13.0.3](https://github.com/zthun/fashion/compare/v13.0.2...v13.0.3) (2026-01-04)

**Note:** Version bump only for package @zthun/fashion

## [13.0.2](https://github.com/zthun/fashion/compare/v13.0.1...v13.0.2) (2026-01-03)

**Note:** Version bump only for package @zthun/fashion

## [13.0.1](https://github.com/zthun/fashion/compare/v13.0.0...v13.0.1) (2025-12-16)
...
## [12.1.1](https://github.com/zthun/fashion/compare/v12.1.0...v12.1.1) (2025-10-27)

**Note:** Version bump only for package @zthun/fashion

## [12.1.0](https://github.com/zthun/fashion/compare/v12.0.1...v12.1.0) (2025-10-27)

### Features

- tile component renders an interactive box tile with correct accessibility ([df276f1](https://github.com/zthun/fashion/commit/df276f14ae0d1d9a0046cf1b90b1920a4b6fa197))

## [12.0.1](https://github.com/zthun/fashion/compare/v12.0.0...v12.0.1) (2025-10-26)

### Bug Fixes

- carousel's root node should now fit the carousel content ([e74af93](https://github.com/zthun/fashion/commit/e74af932c2d430406bfd074b887c7afa981a3063))
...
## [10.2.6](https://github.com/zthun/fashion/compare/v10.2.5...v10.2.6) (2025-09-09)

**Note:** Version bump only for package @zthun/fashion

## [10.2.5](https://github.com/zthun/fashion/compare/v10.2.4...v10.2.5) (2025-09-06)

**Note:** Version bump only for package @zthun/fashion

## [10.2.4](https://github.com/zthun/fashion/compare/v10.2.3...v10.2.4) (2025-07-18)

**Note:** Version bump only for package @zthun/fashion

## [10.2.3](https://github.com/zthun/fashion/compare/v10.2.2...v10.2.3) (2025-07-02)

**Note:** Version bump only for package @zthun/fashion

## [10.2.2](https://github.com/zthun/fashion/compare/v10.2.1...v10.2.2) (2025-06-22)

**Note:** Version bump only for package @zthun/fashion

## [10.2.1](https://github.com/zthun/fashion/compare/v10.2.0...v10.2.1) (2025-06-21)

### Reverts

- stack height and width ([2607e27](https://github.com/zthun/fashion/commit/2607e27befd947b4784117ea96bb4467b7ae8f13))
...
- form auto page demos the form auto component ([571acdc](https://github.com/zthun/fashion/commit/571acdc0f27f6bfff1fd1dd682539e5cab973c8a))
...
- add component to the theme page (missing previously) ([922465b](https://github.com/zthun/fashion/commit/922465be573ccf99158593f570797c77e483373f))
